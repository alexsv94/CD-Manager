...
namespace OrganizerWpf.Icons
{
    ...
    public class MenuItems
    {
        ...
        public static Image Copy => ResourceHelper.GetImageFromResource(_rootPath + "copy.png");
        ...
        public static Image Paste => ResourceHelper.GetImageFromResource(_rootPath + "paste.png");
        public static Image Rename => ResourceHelper.GetImageFromResource(_rootPath + "rename.png");
        public static Image Refresh => ResourceHelper.GetImageFromResource(_rootPath + "refresh.png");
